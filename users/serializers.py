...
from mist.models import Badge, Collectible
...
class ReadOnlyUserSerializer(serializers.ModelSerializer):
    ...
    def get_collectibles(self, obj):
        try: obj.collectibles
        except: obj.collectibles = Collectible.objects.filter(user_id=obj.id)
        return [collectible.collectible_type for collectible in obj.collectibles.all()]
...
class CompleteUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        'is_verified', 'is_pending_verification', 'badges', 'collectibles',
        'is_superuser', 'thumbnail',)
        read_only_fields = ('badges', 'is_verified', 'is_pending_verification', 'collectibles',)
        extra_kwargs = {
